...
with open(r'C:\Users\Joe Fitzgerald\Desktop\597SD\test3.json') as json_file:
...
trainx = np.linspace(0, len(train_Set), 200)
testx = np.linspace(0, len(test_Set), 200)
...
for k in range(len(test_Set)):
    testMSE = (np.square(np.subtract(test_Set[k], trainMean))).mean()
...
plt.xlabel('RTT Time (s)')
plt.ylabel('Probability Density')
plt.title("Probability Density Function of RTT Training Set (File 1)")
plt.text(textx, 0.00036, ("Standard Deviation = " + sdstring), fontsize = 10)
plt.text(textx, 0.00034, ("Mean = " + meanstr), fontsize = 10)
plt.text(0.0005, 0.00032, ("RMSE = " + RMSE_str), fontsize = 10)
plt.show()
...
plt.title("Histogram of RTT Time Training Set (File 1)")
plt.xlabel("RTT Time (s)")
plt.ylabel("Frequency")
plt.text(textx, 28, ("Standard Deviation = " + charttrainsd), fontsize = 10)
plt.text(textx, 26, ("Mean = " + charttrainmean), fontsize = 10)
plt.show()
...
plt.xlabel('RTT Time (s)')
plt.ylabel('Probability Density')
plt.title("Probability Density Function of RTT Test Set (File 1)")
...
plt.title("Histogram of RTT Time Test Set (File 1)")
plt.xlabel("RTT Time (s)")
plt.ylabel("Frequency")
plt.text(textx, 28, ("Standard Deviation = " + charttrainsd), fontsize = 10)
plt.text(textx, 26, ("Mean = " + charttrainmean), fontsize = 10)
